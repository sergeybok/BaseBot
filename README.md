...
Basically what Friendly AI and BaseBot allow you to do is easily develop and customize bots that are easily accessible to you, are highly private, and customaized exactly to your needs -- without dealing with a lot of the frontend dev, backend dev, App Store/Play Store review process, etc. 
